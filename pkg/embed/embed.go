...
// Modified from https://gist.github.com/Necroforger/8b0b70b1a69fa7828b8ad6387ebb3835
...
// NewEmbedWrapper ..
func NewEmbedWrapper(embed *discordgo.MessageEmbed) *EmbedWrapper {
	return &EmbedWrapper{
...
// SetFooterImage ..
func (e *Embed) SetFooterImage(URL string) *Embed {
	e.Footer.IconURL = URL
	e.Footer.ProxyIconURL = URL
	return e
}
